...
extension Difficulty {
    static let regularColors: [BaseQuestionModel] = [
    ...
    static let hardColors: [BaseQuestionModel] = [
        ...
        .init(answer: .init(red: 156, green: 148, blue: 187),
              ...
              notes: "My brain has a thought but it's not family friendly and I don't want to get in legal trouble. We'll go with purple."),
    ...
    static let impossibleColors: [BaseQuestionModel] = [
